...
<button class="btn btn-primary" type="submit" name="search">Show All Items</button>
</form>
</div>
</div>
</section>
    ...
    foreach ($_SESSION["cart_item"] as $item){
        ...
        ?>
           <input type="hidden" value="<?php echo $item['quantity']; ?>" name="quantity[<?php echo $item['code']; ?>]">
                ...
                <td><a href="search-product.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="dist/img/delete.jpg" height="25" width="25" alt="Remove Item" /></a></td>
                </tr>
                <?php
