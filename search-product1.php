...
echo '<script>alert("Invoice genrated successfully. Invoice number is "+"'.$invoiceno.'")</script>';  
 ...
 echo "<script>window.location.href='invoice1.php'</script>";
...
<input type="text" class="form-control" id="validationCustom03" placeholder="Product Name" name="productname">
...
<br><button class="btn btn-primary" type="submit" name="search">Show All Items</button>
</form>
</div>
</div>
</section>
...
{    
?>
<form method="post" action="search-product1.php?action=add&pid=<?php echo $row["id"]; ?>">                                                  
<tr>
<td><?php echo $cnt;?></td>
...
<a id="btnEmpty" href="search-product1.php?action=empty" >Empty Cart</a>
<?php
    ...
    foreach ($_SESSION["cart_item"] as $item){
        ...
        ?>
           <input type="hidden" value="<?php echo $item['quantity']; ?>" name="quantity[<?php echo $item['code']; ?>]">
                ...
                <td><a href="search-product1.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction"><img src="dist/img/delete.jpg" height="25" width="25" alt="Remove Item" /></a></td>
                </tr>
                <?php
...
<div class="col-md-6 mb-10">
<button class="btn btn-primary" type="submit" name="checkout">Order Confirm</button>
</div>
</div>
</form>
